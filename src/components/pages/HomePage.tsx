  ...
  return (
    <Link to={`/notes/${meta.slug}`} className="article-card">
      <div className="article-card-inner">
        ...
        <span className="article-card-read">read <IconArrowRight size={13} /></span>
      </div>
    </Link>
  );
}
        ...
        <div className="hero-inner">
          ...
          <div className="hero-ctas">
            ...
            <a href={personalInfo.github} className="cta-btn cta-github" target="_blank" rel="noopener noreferrer">
              <IconBrandGithub size={16} /><span>GitHub</span>
            </a>
      ...
      <section className="home-section">
        <div className="section-inner">
          <div className="section-header-row">
            ...
            <Link to="/notes" className="section-more">all notes <IconArrowRight size={13} /></Link>
          </div>
      ...
      <section className="home-section metrics-section">
        <div className="section-inner">
          ...
          <Link to="/work" className="section-more" style={{ marginTop: "1.5rem", display: "inline-flex" }}>
            view case studies <IconArrowRight size={13} />
          </Link>
        </div>
      </section>
      ...
      <section className="home-section">
        <div className="section-inner">
          <div className="section-header-row">
            ...
            <Link to="/principles" className="section-more">all principles <IconArrowRight size={13} /></Link>
          </div>
